...
#define MAX_NOTE 109
#define INITIAL_PULSE_WIDTH 128
#define MIN_PULSE_WIDTH 1
#define MAX_PULSE_WIDTH 256
#define INITIAL_RING_MOD 13
#define MIN_RING_MOD 1
#define MAX_RING_MOD MAX_NOTE
...
#define MAX_RESONANCE 256
#define INITIAL_CUTOFF 256
#define MIN_CUTOFF 1
#define MAX_CUTOFF 256
#define MIN_PITCH 1
#define MAX_PITCH MAX_NOTE
#define MIN_PARAM 1
